	...
	<footer class="entry-meta">
		<?php if ( comments_open() && ! is_single() ) : ?>
			<div class="comments-link">
				<?php comments_popup_link( '<span class="leave-reply">' . __( 'Leave a comment', 'pv' ) . '</span>', __( 'One comment so far', 'pv' ), __( 'View all % comments', 'pv' ) ); ?>
			</div><!-- comments-link -->
